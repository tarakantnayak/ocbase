...
class ControllerCheckoutCart extends Controller {
	...
	public function add() {
		...
		$logger->write("product id:".$product_id);
		if ($product_info) {
			...
			if (!$json) {
				...
				$logger->write("calculating total");
			} else {
			    $logger->write("redirecting to product page");
	...
	public function validateVoucher() {
	    ...
	    if (empty($this->request->get['voucher'])) {
	        $json['error'] = $this->language->get('error_empty');
	    } elseif ($voucher_info) {
	        $this->session->data['voucher'] = $this->request->get['voucher'];
