...
class ControllerAccountLogin extends Controller {
	...
	protected function validate() {
	    ...
	    $this->request->post['email'] = $this->request->post['user_name'];
		$login_info = $this->model_account_customer->getLoginAttempts($this->request->post['user_name']);
		...
		$customer_info = $this->model_account_customer->getCustomerByUserName($this->request->post['user_name']);
