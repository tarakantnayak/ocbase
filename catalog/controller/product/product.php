...
class ControllerProductProduct extends Controller {
	...
	public function index() {
	   $logger = new Log("product_index");
		...
		if ($product_info) {
			...
			$data['short_desc'] = substr(html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8'), 0, 200).'...';
			...
			for ($i=$data['minimum']+1; $i< $data['minimum'] + 5; $i++){
			    $data['quantity'][] = $i;
			}
			...
			$data['product_reviews'] = $this->getProductReviews($product_id);
			
			$data['avg_rating'] = (int)$product_info['rating'];
			...
			$data['related_products'] = $this->model_common_common->getProductData($results);
	...
	public function getProductReviews($product_id) {
	    ...
	    $results = $this->model_catalog_product->getProductReviews($product_id);
