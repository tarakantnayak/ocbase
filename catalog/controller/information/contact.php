...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->send();
			$message = 'Your enquiry has been successfully sent to the company.';
			$this->response->redirect($this->url->link('information/contact','&success='.$message, true));
		} else {
